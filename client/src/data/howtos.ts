...
export const HOWTOS: HowTo[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { text: "For SMS follow-ups, keep your message body under 90 characters — the rating link and an unsubscribe link are added automatically after it." },
      { text: "SMS messages include an unsubscribe link automatically. If a customer taps it, they are set to Do Not Contact and no further messages are sent. WhatsApp messages include a 'Reply STOP' opt-out." },
