...
const FEATURES = [
  ...
  },
  {
    ...
    items: [
      "Full analytics dashboard with 10+ charts",
      "Requests vs reviews over time line chart",
      "Requests vs reviews by channel (grouped bar chart)",
      "Best day of the week to send — see when customers respond most",
      "Average time to review — histogram from same day to 7+ days",
      "Follow-up effectiveness — compare conversion with and without follow-ups",
      "Template performance — response rate per template",
      "Review platform breakdown — Google vs Trustpilot vs Facebook etc.",
      "Requests vs reviews by team member (owner accounts)",
      "Conversion funnel: sent → clicked → reviewed",
      "Star rating distribution",
      "Filter analytics by date range, channel, or team member",
