    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans">
      ...
      <section id="pricing" className="py-20 px-5 bg-white">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
            {PLANS.map((plan, i) => (
              <div key={i} className={`rounded-2xl border p-8 flex flex-col ${plan.highlight ? "border-2 shadow-lg relative" : "border-gray-200"}`} style={plan.highlight ? { borderColor: PRIMARY } : {}}>
                ...
                <p className="text-sm font-medium mb-8" style={{ color: PRIMARY }}>{plan.limit}</p>
                <button onClick={() => navigate("/register")} className={`w-full py-3 rounded-xl font-semibold text-sm transition-opacity hover:opacity-90 mt-auto ${plan.highlight ? "text-white" : "border-2"}`} style={plan.highlight ? { backgroundColor: PRIMARY } : { borderColor: PRIMARY, color: PRIMARY }}>
                  Start Free Trial
                </button>
              </div>
            ))}
          ...
          {/* Shared features list — once, below both cards */}
          <div className="max-w-2xl mx-auto mt-8 bg-gray-50 rounded-2xl p-6">
            <p className="text-sm font-semibold text-gray-700 mb-4">All plans include:</p>
          ...
          <p className="text-center text-gray-400 text-sm mt-4">Annual billing available — save the equivalent of 1 month per year.</p>
        </div>
      </section>
